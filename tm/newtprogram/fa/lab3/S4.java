...
{  
    ...
    IOException
    {
        System.out.println("S4 compiler written by Kevin Dougherty");
        ...
        outFile.println("; from S4 compiler written by Kevin Dougherty");
...
class S4TokenMgr implements S4Constants
{
    ...
    public Token getNextToken()
    {
        ...
        if (currentChar == '"')
        {
            ...
            do  // build token image in buffer
            {
                ...
                getNextChar();
                if (inputLine.charAt(currentColumnNumber-1) == '/')
                    dontCount = true;
            } while (currentChar != '"' && dontCount == false);
            buffer.append('"');
    ...
    private void getNextChar()
    {
        ...
        if (currentChar == '/')
            if (inputLine.charAt(currentColumnNumber) == '/' && inString == false)
                currentChar = '\n';
    }
}                                   // end of S4TokenMgr
//======================================================
class S4Parser implements S4Constants
{
    ...
    //-----------------------------------------
    public S4Parser(S4SymTab st, S4TokenMgr tm, 
    S4CodeGen cg)
    {
        this.st = st;
        this.tm = tm;
    ...
    private void ifStatement()
    {
        ...
        statement();
        elseStatement(label1);
        
    }
    //-----------------------------------------
    private void elseStatement(String label1)
    {
        switch(currentToken.kind)
        {
            case ELSE:
